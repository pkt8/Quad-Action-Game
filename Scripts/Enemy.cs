...
public class Enemy : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        if(other.tag == "Melee")
        {
            ...
            StartCoroutine(OnDamage(reactVec, other.tag, false));
        }
    ...
    IEnumerator OnDamage(Vector3 reactVec, string type, bool isGrenade)
    {
